      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-ink/70">
            Choose monthly for flexibility or yearly for the best value. Both plans unlock the same mock generator flow.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 text-sm font-semibold text-ink/70">
                  Includes {plan.textGenerationLimit.toLocaleString()} text generations per {plan.billingInterval}.
                </p>
